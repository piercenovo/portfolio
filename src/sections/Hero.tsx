...
export function Hero() {
  ...
  const { cta } = t.header
  return (
    <main id='#' className='flex min-h-screen flex-col justify-evenly items-center w-full px-2 sm:px-0'>
      <div className='flex flex-col gap-1 pt-28 w-full max-w-3xl lg:max-w-4xl xl:max-w-5xl px-2 sm:px-8 md:px-6'>
        <h3
